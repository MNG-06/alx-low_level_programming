...
/**
 * printf_char - printing a char from var args
 *
...
/**
 * printf_int - printing an int from var args
 *
 * @list: va_list to print from
 *
 * Return: void
...
/**
 * printf_float - printing a float from var args
 *
 * @list: va_list to print from
 *
 * Return: void
...
/**
 * printf_string - printing a string from var args
 *
 * @list: va_list to print from
 *
 * Return: void
